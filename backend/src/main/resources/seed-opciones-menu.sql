...
('menu_certificados', 'Certificados', 'Menú', 12),
('menu_catalogo_marcas', 'Marcas', 'Menú', 13),
('menu_catalogo_modelos', 'Modelos', 'Menú', 14),
('menu_catalogo_tipo_vehiculo', 'Tipos de Vehículo', 'Menú', 15),
('menu_catalogo_clases', 'Clases', 'Menú', 16),
('menu_catalogo_categorias', 'Categorías', 'Menú', 17),
