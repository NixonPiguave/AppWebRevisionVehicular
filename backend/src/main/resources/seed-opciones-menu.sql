...
('menu_catalogo_subcategorias', 'Subcategorías', 'Menú', 19),
('menu_catalogo_tipo_combustible', 'Tipos de Combustible', 'Menú', 20),
('menu_catalogo_tipo_matricula', 'Tipos de Matrícula', 'Menú', 21),
('menu_catalogo_traccion', 'Tracción', 'Menú', 22),
('menu_catalogo_ejes', 'Ejes', 'Menú', 23),
('menu_catalogo_capacidad', 'Capacidad de Carga', 'Menú', 24),
('menu_catalogo_ambito', 'Ámbito Operacional', 'Menú', 25),
('menu_inspeccion_turnos_pagados', 'Registrar Inspección', 'Menú', 26),
('menu_inspeccion_lineas', 'Líneas de Inspección', 'Menú', 27),
('menu_inspeccion_metodos', 'Métodos de Inspección', 'Menú', 28),
('menu_inspeccion_equipos', 'Equipos', 'Menú', 29),
('menu_defectos_familia', 'Familias de Defectos', 'Menú', 30),
('menu_defectos_subfamilia', 'Subfamilias de Defectos', 'Menú', 31),
('menu_defectos_categoria', 'Categorías de Defectos', 'Menú', 32),
('menu_defectos_tipos', 'Tipos de Defectos', 'Menú', 33),
('menu_defectos', 'Defectos', 'Menú', 34),
('menu_ant', 'ANT / Trámites', 'Menú', 35),
('menu_umbral_unidades', 'Unidades de Medida', 'Menú', 36),
('menu_umbral_descripcion', 'Descripción de Umbral', 'Menú', 37),
('menu_umbral', 'Umbral', 'Menú', 38),
('menu_usuarios', 'Usuarios', 'Menú', 39),
('menu_roles', 'Roles', 'Menú', 40),
('menu_areas', 'Áreas', 'Menú', 41),
('menu_empresa', 'Empresa', 'Menú', 42),
('menu_turnos', 'Turnos', 'Menú', 43),
('menu_auditoria', 'Auditoría', 'Menú', 44),
('menu_accesos_rol', 'Accesos por rol', 'Menú', 45),
('menu_sesiones_activas', 'Sesiones activas', 'Menú', 46),
('menu_registro_observaciones', 'Registro de Observaciones', 'Menú', 47),
('menu_registro_incidentes', 'Registro de Incidentes', 'Menú', 48),
('menu_anulacion_tramites', 'Anulación de Trámites', 'Menú', 49),
('menu_registro_base_unica', 'Registro Base Única', 'Menú', 50),
